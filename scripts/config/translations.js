...
const T = {
    ur: {
        ...
        nav: ['📝 نئی', '💰 ادائیگی', '📒 لیجر', '📋 ریکارڈ', '📊 رپورٹ', '📋 ڈیلی', '⚙️ سیٹنگ'],
        entry: 'نئی ٹرانسپورٹ انٹری 🚌', date: 'تاریخ', party: 'ٹرانسپورٹر', hajiParty: 'پارٹی', sector: 'سیکٹر', transporterLbl: 'ٹرانسپورٹر',
        ...
        todaySummary: 'آج کا خلاصہ 📊', todayParties: 'ٹرانسپورٹر آج', todayHujjaj: 'کل حاجی آج', todayAmount: 'کل رقم (SAR)', todayTrips: 'کل سفر آج',
        selectParty: '-- ٹرانسپورٹر منتخب --', selectSector: '-- سیکٹر منتخب --',
        payTitle: 'ٹرانسپورٹر کی ادائیگی درج کریں 💰', received: 'موصول رقم (SAR)', method: 'ادائیگی کا طریقہ',
        cash: 'نقد', bank: 'بینک', cheque: 'چیک', online: 'آن لائن',
        savePay: '✅ ادائیگی محفوظ کریں', recentPay: 'حالیہ ادائیگیاں 💳',
        ledgerTitle: 'ٹرانسپورٹر لیجر 📒', selectAll: '-- سب ٹرانسپورٹر --', fromDate: 'تاریخ سے', toDate: 'تاریخ تک',
        ...
        totalDebit: 'کل واجب', totalCredit: 'کل وصول', totalPaid: 'کل ادا', surplus: 'زائد ادائیگی', owing: 'باقی واجب',
        paidCol: 'ادا (SAR)', paidTx: '💰 ادا',
        ...
        numCol: '#', dateCol: 'تاریخ', partyCol: 'ٹرانسپورٹر', sectorCol: 'سیکٹر', transportCol: 'ٹرانسپورٹ',
        ...
        byDate: 'تاریخ وائز', byParty: 'ٹرانسپورٹر وائز', bySector: 'سیکٹر وائز', byTransporter: 'ٹرانسپوٹر وائز',
        ...
        setParties: 'ٹرانسپورٹر 👥', setSectors: 'سیکٹر 🗺️', setHajiParties: 'حاجی پارٹی 👥',
        newPartyLbl: 'نیا ٹرانسپورٹر', newSectorLbl: 'نیا سیکٹر', newHajiPartyLbl: 'نئی حاجی پارٹی',
        ...
        noneParty: 'کوئی ٹرانسپورٹر نہیں', noneSector: 'کوئی سیکٹر نہیں', noneHajiParty: 'کوئی حاجی پارٹی نہیں',
        addPartyTitle: '➕ نیا ٹرانسپورٹر شامل کریں', addSectorTitle: '➕ نیا سیکٹر شامل کریں',
        partyPlaceholder: 'ٹرانسپورٹر کا نام', sectorPlaceholder: 'مثلاً: جدہ ➜ مکہ', hajiPartyPlaceholder: 'حاجی پارٹی کا نام',
        ...
        defaultParties: ['ٹرانسپورٹر الف', 'ٹرانسپورٹر ب'],
        sectorRef: 'سفر:', hujPerSector: 'حاجی ×',
        payMethodRef: 'ادائیگی —',
        runBalance: '(باقی)', 'runOwing': '(واجب)',
        methodCol: 'طریقہ', notesCol: 'نوٹس',
        codeCol: 'کوڈ', searchParty: '🔍 ٹرانسپورٹر تلاش کریں...', noMatch: 'کوئی نتیجہ نہیں',
        partyCodeLbl: 'ٹرانسپورٹر کوڈ',
        ...
        renameParty: 'ٹرانسپورٹر کا نام تبدیل کریں ✏️', oldName: 'پرانا نام', newName: 'نیا نام',
        ...
        dnDate: 'تاریخ', dnRef: 'واوچر نمبر', dnParty: 'ٹرانسپوٹر', dnNewParty: 'پارٹی کا نام',
        ...
        dnNature: 'نوعیت', dnNatureArrival: 'Arrivel', dnNatureOther: 'Other Trnsport',
    ...
    en: {
        ...
        nav: ['📝 New', '💰 Payment', '📒 Ledger', '📋 Records', '📊 Report', '📋 Daily', '⚙️ Settings'],
        entry: 'New Transport Entry 🚌', date: 'Date', party: 'Transporter', hajiParty: 'Party', sector: 'Sector', transporterLbl: 'Transporter',
        ...
        todaySummary: "Today's Summary 📊", todayParties: 'Transporters Today', todayHujjaj: 'Total Pilgrims', todayAmount: 'Total Amount (SAR)', todayTrips: 'Total Trips',
        selectParty: '-- Select Transporter --', selectSector: '-- Select Sector --',
        payTitle: 'Record Transporter Payment 💰', received: 'Amount Received (SAR)', method: 'Payment Method',
        cash: 'Cash', bank: 'Bank', cheque: 'Cheque', online: 'Online',
        savePay: '✅ Save Payment', recentPay: 'Recent Payments 💳',
        ledgerTitle: 'Transporter Ledger 📒', selectAll: '-- All Transporters --', fromDate: 'From Date', toDate: 'To Date',
        ...
        totalDebit: 'Total Debit', totalCredit: 'Total Credit', totalPaid: 'Total Paid', surplus: 'Surplus', owing: 'Balance Due',
        paidCol: 'Paid (SAR)', paidTx: '💰 Paid',
        ...
        numCol: '#', dateCol: 'Date', partyCol: 'Transporter', sectorCol: 'Sector', transportCol: 'Transport',
        ...
        byDate: 'By Date', byParty: 'By Transporter', bySector: 'By Sector', byTransporter: 'By Transporter',
        ...
        setParties: 'Transporters 👥', setSectors: 'Sectors 🗺️', setHajiParties: 'Haji Parties 👥',
        newPartyLbl: 'New Transporter', newSectorLbl: 'New Sector', newHajiPartyLbl: 'New Haji Party',
        add: '➕ Add', addedOk: '✅ Added', alreadyExists: '⚠️ Already exists', enterName: '⚠️ Enter a name',
        usedWarning: 'Used in records. Delete anyway?',
        noneParty: 'No transporters', noneSector: 'No sectors', noneHajiParty: 'No Haji Parties',
        addPartyTitle: '➕ Add New Transporter', addSectorTitle: '➕ Add New Sector',
        partyPlaceholder: 'Transporter name', sectorPlaceholder: 'e.g. Jeddah ➜ Makkah', hajiPartyPlaceholder: 'Haji Party Name',
        ...
        defaultParties: ['Transporter A', 'Transporter B'],
        sectorRef: 'Trip:', hujPerSector: 'Pilgrims ×',
        payMethodRef: 'Payment —',
        runBalance: '(surplus)', 'runOwing': '(due)',
        methodCol: 'Method', notesCol: 'Notes',
        codeCol: 'Code', searchParty: '🔍 Search transporter...', noMatch: 'No match found',
        partyCodeLbl: 'Transporter Code',
        ...
        renameParty: 'Rename Transporter ✏️', oldName: 'Current Name', newName: 'New Name',
        ...
        dnDate: 'Date', dnRef: 'Voucher No.', dnParty: 'Transporter', dnNewParty: 'Party Name',
        ...
        dnNature: 'Nature', dnNatureArrival: 'Arrivel', dnNatureOther: 'Other Trnsport',
    ...
    ar: {
        ...
        nav: ['📝 جديد', '💰 دفعة', '📒 دفتر', '📋 سجلات', '📊 تقرير', '📋 يومي', '⚙️ إعدادات'],
        entry: 'إدخال نقل جديد 🚌', date: 'التاريخ', party: 'الناقل', hajiParty: 'المجموعة', sector: 'القطاع', transporterLbl: 'الناقل',
        ...
        todaySummary: 'ملخص اليوم 📊', todayParties: 'الناقلين اليوم', todayHujjaj: 'إجمالي الحجاج', todayAmount: 'إجمالي المبلغ (ريال)', todayTrips: 'إجمالي الرحلات',
        selectParty: '-- اختر الناقل --', selectSector: '-- اختر القطاع --',
        payTitle: 'تسجيل دفعة الناقل 💰', received: 'المبلغ المستلم (ريال)', method: 'طريقة الدفع',
        cash: 'نقداً', bank: 'بنك', cheque: 'شيك', online: 'أون لاين',
        savePay: '✅ حفظ الدفعة', recentPay: 'الدفعات الأخيرة 💳',
        ledgerTitle: 'دفتر حساب الناقل 📒', selectAll: '-- كل الناقلين --', fromDate: 'من تاريخ', toDate: 'إلى تاريخ',
        ...
        totalDebit: 'إجمالي المطلوب', totalCredit: 'إجمالي المستلم', totalPaid: 'إجمالي المدفوع', surplus: 'دفع زيادة', owing: 'الرصيد المستحق',
        paidCol: 'المدفوع (ريال)', paidTx: '💰 مدفوع',
        ...
        numCol: '#', dateCol: 'التاريخ', partyCol: 'الناقل', sectorCol: 'القطاع', transportCol: 'وسيلة النقل',
        ...
        byDate: 'حسب التاريخ', byParty: 'حسب الناقل', bySector: 'حسب القطاع', byTransporter: 'حسب الناقل',
        ...
        setParties: 'الناقلين 👥', setSectors: 'القطاعات 🗺️', setHajiParties: 'حملات الحج 👥',
        newPartyLbl: 'ناقل جديد', newSectorLbl: 'قطاع جديد', newHajiPartyLbl: 'حملة جديدة',
        ...
        noneParty: 'لا يوجد ناقلين', noneSector: 'لا توجد قطاعات', noneHajiParty: 'لا توجد حملات',
        addPartyTitle: '➕ إضافة ناقل جديد', addSectorTitle: '➕ إضافة قطاع جديد',
        partyPlaceholder: 'اسم الناقل', sectorPlaceholder: 'مثال: جدة ➜ مكة', hajiPartyPlaceholder: 'اسم الحملة',
        ...
        defaultParties: ['الناقل الأول', 'الناقل الثاني'],
        sectorRef: 'رحلة:', hujPerSector: 'حجاج ×',
        payMethodRef: 'دفعة —',
        runBalance: '(فائض)', 'runOwing': '(مستحق)',
        methodCol: 'الطريقة', notesCol: 'ملاحظات',
        codeCol: 'الرمز', searchParty: '🔍 ابحث عن ناقل...', noMatch: 'لا توجد نتائج',
        partyCodeLbl: 'رمز الناقل',
        ...
        renameParty: 'إعادة تسمية الناقل ✏️', oldName: 'الاسم الحالي', newName: 'الاسم الجديد',
        ...
        dnDate: 'التاريخ', dnRef: 'رقم الإيصال', dnParty: 'الناقل', dnNewParty: 'اسم المجموعة',
        ...
        dnNature: 'طبيعة', dnNatureArrival: 'Arrivel', dnNatureOther: 'Other Trnsport',
